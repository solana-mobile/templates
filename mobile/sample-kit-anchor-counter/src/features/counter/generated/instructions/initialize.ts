...
>(
  input: InitializeAsyncInput<TAccountCounter, TAccountPayer, TAccountSystemProgram>,
  config?: { programAddress?: TProgramAddress },
): Promise<InitializeInstruction<TProgramAddress, TAccountCounter, TAccountPayer, TAccountSystemProgram>> {
  // Program address.
  ...
  return Object.freeze({
    ...
    programAddress,
  } as InitializeInstruction<TProgramAddress, TAccountCounter, TAccountPayer, TAccountSystemProgram>)
}
...
export function getInitializeInstruction<
  ...
  TProgramAddress extends Address = typeof COUNTER_PROGRAM_ADDRESS,
>(
  input: InitializeInput<TAccountCounter, TAccountPayer, TAccountSystemProgram>,
  config?: { programAddress?: TProgramAddress },
): InitializeInstruction<TProgramAddress, TAccountCounter, TAccountPayer, TAccountSystemProgram> {
  // Program address.
  const programAddress = config?.programAddress ?? COUNTER_PROGRAM_ADDRESS
...
export function parseInitializeInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
  ...
  return {
    ...
    accounts: { counter: getNextAccount(), payer: getNextAccount(), systemProgram: getNextAccount() },
