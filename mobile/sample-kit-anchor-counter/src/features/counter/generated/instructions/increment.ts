...
export type IncrementInstructionData = { discriminator: ReadonlyUint8Array; amount: bigint }
...
>(
  ...
  // Original accounts.
  const originalAccounts = { counter: { value: input.counter ?? null, isWritable: true } }
