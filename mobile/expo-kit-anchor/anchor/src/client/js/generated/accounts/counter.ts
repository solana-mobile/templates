...
export const COUNTER_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([255, 176, 4, 245, 188, 253, 124, 25])

export function getCounterDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(COUNTER_DISCRIMINATOR)
}

export type Counter = { discriminator: ReadonlyUint8Array; count: bigint; authority: Address }

export type CounterArgs = { count: number | bigint; authority: Address }
